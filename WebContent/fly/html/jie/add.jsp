      ...
      <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
          <div class="layui-tab-item layui-show">
            <form action="PostAction.action" method="post">
              <div class="layui-row layui-col-space15 layui-form-item">
                <div class="layui-col-md3">
                  <label class="layui-form-label">所在专栏</label>
                  <div class="layui-input-block">
                    <select lay-verify="required" name="post.sort" lay-filter="column"> 
                      <option></option> 
                ...
                <div class="layui-col-md9">
                  ...
                  <div class="layui-input-block">
                    <input type="text" id="L_title" name="post.title" required lay-verify="required" autocomplete="off" class="layui-input">
              ...
              <div class="layui-form-item layui-form-text">
                <div class="layui-input-block">
                  <textarea id="L_content" name="post.content" required lay-verify="required" placeholder="详细描述" class="layui-textarea fly-editor" style="height: 260px;"></textarea>
                </div>
              </div>
              ...
              <div class="layui-form-item">
                <button class="layui-btn" lay-filter="*" lay-submit onclick="submitfunc()">立即发布</button>
              </div>
            </form>
          </div>
        </div>
